...
class TournamentTest(unittest.TestCase):
    ...
    def setUp(self):    # не прописала декоратор '@unittest.skipIf', т.к. при отсутствии тестов выполняться не будет
    ...
    def test_start1(self):
        ...
        self.assertTrue(self.all_results[len(self.all_results)][len(finishers)] == last_runner)
